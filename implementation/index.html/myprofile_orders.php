    ...
    <body>
        <main></main>
            ...
            <aside>
                ...
                <div class="sidebar">
                    <a href="myprofile_personal_info.php">Personal Information</a>
                    <a class="active" href="#myOrders">My Orders</a>
            ...
            <article>
                <table>
                <tr>                 
                    <th>Order Number</th><th>Order Date</th><th>Payment Status</th><th>Payment Type</th>
                </tr>
                <?php
                    $email = "customer10@outlook.com";
                    $sql = "Select * From orders where customermail = '$email'";

                    $result = $conn->query($sql);
                   
                    foreach ($result as $row)
                    {
                        echo '<tr><td>'. $row['ordernumber'] . "</td><td>" . $row['orderdate'] . '</td>';
                        if($row['paymentstatus']){
                            echo '<td>Paid</td>';
                        }else{
                            echo '<td>Not Paid</td>';
                        }
                        echo '<td>' . $row['paymenttype'] . "</td></tr>";
                    }
