...
insert into customer
	values
		('customer1@gmail.com', '+31123456789', '@Customer1', 'ACTIVE', 'VENLO', 'john', '1950-01-20' ),
		('customer2@hotmail.com', '+41123456789', '@Customer2', 'DISABLED', 'Spencer street 11 1234AA Venlo', 'andrew', '2000-12-12'),
		('customer3@fontys.nl', '+49123456789', '@Customer3', 'ACTIVE', 'my house', 'maria', '1994-04-27'),
		('customer4@fontys.nl', '+34987654321', '@Customer4', 'ACTIVE', 'AMSTERDAM', 'mathew', '2002-08-20'),
		('customer5@fontys.nl', '+049987654321', '@Customer5', 'DISABLED', 'Kleve', 'lia mathius', '1975-06-15');
